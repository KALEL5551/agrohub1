      ...
      <div className="fixed right-0 top-0 h-full w-72 bg-card shadow-xl animate-slide-in-right">
        <div className="flex items-center justify-between p-4 border-b">
          <div className="flex items-center gap-2">
            ...
            <span className="font-heading font-bold">Agro Hub</span>
          </div>
        ...
        <nav className="p-4 space-y-1">
          ...
          {user ? (
            <>
              <Link href="/dashboard" onClick={closeMobileNav} className="block px-3 py-2.5 rounded-lg text-sm font-medium hover:bg-muted">
                Dashboard
              </Link>
              <Link href="/orders" onClick={closeMobileNav} className="block px-3 py-2.5 rounded-lg text-sm font-medium hover:bg-muted">
                Orders
              </Link>
              <Link href="/chat" onClick={closeMobileNav} className="block px-3 py-2.5 rounded-lg text-sm font-medium hover:bg-muted">
                Messages
              </Link>
