...
// Agriculture-only — electronics removed
...
// What sub-type is this listing? e.g. "seeds" | "pesticide" | "produce_fresh" | "expert_service"
...
export interface Product {
  ...
  /** The specific crop/animal/fish, e.g. "tomato" | "goat" | "tilapia" */
  subcategory: string;
  /** What the seller is offering: seeds | pesticide | produce_fresh | live_animals etc. */
